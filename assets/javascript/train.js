var config = {
    apiKey: "AIzaSyCDipF3xqb0Ylt3FNS2f1zQm6Qz7dzOVTE",
    authDomain: "train-a436a.firebaseapp.com",
    databaseURL: "https://train-a436a.firebaseio.com",
    projectId: "train-a436a",
    storageBucket: "train-a436a.appspot.com",
    messagingSenderId: "792171616441"
  };
...
$('#train-name').val(sessionStorage.getItem('freq'));
...
$('#submit').on('click', function(event){
  event.preventDefault();
      ...
      if  ($('#train-name').val().trim() === "" ||
            ...
            $('#frequency').val().trim() === "" )
           { 
             alert("Please fill out all the details to add new Train");
      } else {
